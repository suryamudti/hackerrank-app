...
class ContentRepositoryImplTest {
    ...
    @Test
    fun `getAllStructures maps entity to domain correctly`() =
        runTest {
    ...
    @Test
    fun `getStructuresByCategory filters and maps correctly`() =
        runTest {
    ...
    @Test
    fun `getStructureBySlug returns mapped structure when found`() =
        runTest {
    ...
    @Test
    fun `getStructureBySlug returns null when not found`() =
        runTest {
    ...
    @Test
    fun `getAllCategories maps strings to category enums`() =
        runTest {
