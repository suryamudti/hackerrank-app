...
class ObserveProblemsUseCaseTest {
    ...
    @Test
    fun `invoke returns empty solved set when none solved`() = runTest {
        every { problemRepository.getAllProblems() } returns flowOf(problems)
