...
object SeedData {
    fun getStructures(): List<DataStructureEntity> =
        listOf(
            // ────────────── LINEAR ──────────────
            DataStructureEntity(
        ...
        buildList {
            ...
            add(
                QuizQuestionEntity(
                    "q_array_2",
                    "array",
                    "Which of the following is a key characteristic of an array?",
                    """["Random access by index","Elements are stored non-contiguously","Each element has a pointer to the next","Dynamic size by default"]""",
                    0,
            ...
            add(
                QuizQuestionEntity(
                    "q_array_4",
                    "array",
                    "In most programming languages, arrays are:",
                    """["Mutable by default","Immutable by default","Always fixed-size","Homogeneous (same data type)"]""",
                    3,
            ...
            add(
                QuizQuestionEntity(
                    "q_ll_2",
                    "linked_list",
                    "A doubly linked list differs from a singly linked list in that it has:",
                    """["A head pointer","A tail pointer","Both next and prev pointers","Faster search"]""",
                    2,
            ...
            add(
                QuizQuestionEntity(
                    "q_ll_4",
                    "linked_list",
                    "Which scenario is a linked list preferred over an array?",
                    """["Random access is frequently needed","Frequent insertions/deletions at arbitrary positions","Memory efficiency is critical","The data size is fixed"]""",
                    1,
            ...
            add(
                QuizQuestionEntity(
                    ...
                    """["FIFO (First-In-First-Out)","LIFO (Last-In-First-Out)","Priority-based","Round-robin"]""",
                    1,
            ...
            add(
                QuizQuestionEntity(
                    "q_stack_2",
                    "stack",
                    "Which data structure is commonly used for implementing the 'undo' feature in text editors?",
            ...
            add(
                QuizQuestionEntity(
                    "q_stack_3",
                    "stack",
                    "What is output of: push(1), push(2), pop(), push(3), peek()?",
                    """["1","2","3","Error"]""",
                    2,
            ...
            add(
                QuizQuestionEntity(
                    ...
                    """["LIFO (Last-In-First-Out)","FIFO (First-In-First-Out)","Priority-based","Random"]""",
                    1,
            ...
            add(
                QuizQuestionEntity(
                    "q_queue_2",
                    "queue",
                    "In BFS (Breadth-First Search), which data structure is used to track nodes to visit?",
            ...
            add(
                QuizQuestionEntity(
                    ...
                    "queue",
                    "What is a Deque?",
                    """["A queue that only allows insertion at front","A double-ended queue allowing inserts/removes at both ends","A queue with priority ordering","A queue with limited capacity"]""",
                    1,
            ...
            add(
                QuizQuestionEntity(
                    ...
                    """["Root","Internal node","Leaf","Sibling"]""",
                    2,
            ...
            add(
                QuizQuestionEntity(
                    "q_bt_3",
                    "binary_tree",
                    "In which traversal order is the root visited first?",
            ...
            add(
                QuizQuestionEntity(
                    "q_bst_1",
                    "bst",
                    "In a BST, for any node, values in the left subtree are:",
                    """["Greater than the node","Less than the node","Equal to the node","Unordered"]""",
                    1,
            ...
            add(
                QuizQuestionEntity(
                    "q_bst_2",
                    "bst",
                    "What traversal of a BST produces sorted order?",
            ...
            add(
                QuizQuestionEntity(
                    "q_heap_1",
                    "heap",
                    "In a Max-Heap, the root element is always the:",
                    """["Smallest element","Largest element","Median element","Most recently added"]""",
                    1,
            ...
            add(
                QuizQuestionEntity(
                    "q_heap_2",
                    "heap",
                    "What is the time complexity to extract the min/max from a heap?",
            ...
            add(
                QuizQuestionEntity(
                    "q_heap_3",
                    "heap",
                    "A heap is a complete binary tree. This means:",
                    """["All levels are completely filled","All levels except possibly the last are filled, left to right","Every node has exactly 2 children","The tree is balanced like an AVL"]""",
                    1,
            ...
            add(
                QuizQuestionEntity(
                    "q_trie_1",
                    "trie",
                    "What is the primary use case for a Trie?",
                    """["Sorting numbers","Prefix-based string search","Graph traversal","Image processing"]""",
                    1,
            ...
            add(
                QuizQuestionEntity(
                    ...
                    """["O(1)","O(log m)","O(m)","O(m × alphabet_size)"]""",
                    2,
            ...
            add(
                QuizQuestionEntity(
                    "q_graph_3",
                    "graph",
                    "In an undirected graph, if there is an edge between u and v, then:",
                    """["u is the parent of v","v is the parent of u","The edge is bidirectional","The edge has a direction from u to v"]""",
                    2,
            ...
            add(
                QuizQuestionEntity(
                    "q_hash_1",
                    "hash_table",
                    "What is the average-case time complexity for search in a hash table?",
                    """["O(1)","O(log n)","O(n)","O(n²)"]""",
                    0,
            ...
            add(
                QuizQuestionEntity(
                    ...
                    """["The later key overwrites the earlier","It's called a collision","The hash table throws an error","The keys are merged"]""",
                    1,
            ...
            add(
                QuizQuestionEntity(
                    ...
                    """["The number of buckets","The ratio of filled buckets to total buckets","The hash function output size","The size of each key"]""",
                    1,
            ...
            add(
                QuizQuestionEntity(
                    "q_dsu_1",
                    "disjoint_set",
                    "What are the two primary operations of a Union-Find data structure?",
                    """["Push and Pop","Add and Remove","Find and Union","Insert and Delete"]""",
                    2,
            ...
            add(
                QuizQuestionEntity(
                    "q_dsu_2",
                    "disjoint_set",
                    "Which algorithm uses Union-Find to find MST?",
                    """["Dijkstra's","Bellman-Ford","Kruskal's","Floyd-Warshall"]""",
                    2,
            ...
            add(
                QuizQuestionEntity(
                    "q_seg_2",
                    "segment_tree",
                    "Approximately how much space does a segment tree need for an array of size n?",
                    """["O(n)","O(2n)","O(4n)","O(n²)"]""",
                    2,
