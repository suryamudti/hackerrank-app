...
@Composable
fun DataStructureCategory.localizedName(): String = stringResource(
    when (this) {
...
@Composable
fun Difficulty.localizedName(): String = stringResource(
    when (this) {
...
@Composable
fun ProblemCategory.localizedName(): String = stringResource(
    when (this) {
...
@Composable
fun BadgeDefinition.localizedTitle(): String = stringResource(
    when (this) {
...
@Composable
fun BadgeDefinition.localizedDescription(): String = stringResource(
    when (this) {
...
fun Badge.localizedTitle(): String {
    ...
    return if (def != null) def.localizedTitle() else name
}
